...
export default function MultipleChoicePart2({
  onComplete,
  recordings,
  setUserAnswers,
  userAnswers,
  ...
  const allQuestionsAnswered = userAnswers[3] !== null && userAnswers[4] !== null

  // Función para continuar a la siguiente parte
  const handleContinue = () => {
    // Verificar si hay más de una respuesta "No lo sé" en total
